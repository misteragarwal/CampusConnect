...
const mockAccommodations: Accommodation[] = [
  {
    ...
    details: "Fully furnished flat with AC in both rooms. Looking for 1 Flatmate. Girls preferred.",
    postedBy: "Neha G.",
  ...
  },
  {
    ...
    mapUrl: "https://www.google.com/maps?q=Howrah+Station+Kolkata&output=embed",
  },
  {
    id: "3",
